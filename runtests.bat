...
python -m nose2 -s tests test_spectrallibraries_core & move nose2-junit.xml test-reports/today/test_spectrallibraries_core.xml
python -m nose2 -s tests test_spectrallibraries_io & move nose2-junit.xml test-reports/today/test_spectrallibraries_io.xml
python -m nose2 -s tests test_spectrallibraries_plotting & move nose2-junit.xml test-reports/today/test_spectrallibraries_plotting.xml
