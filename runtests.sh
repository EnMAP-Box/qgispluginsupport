...
python3 -m coverage run --rcfile=.coveragec --append  speclib/test_speclib_io_asd.py
python3 -m coverage run --rcfile=.coveragec --append  speclib/test_speclib_processing.py
python3 -m coverage run --rcfile=.coveragec --append  speclib/test_speclib_core.py
python3 -m coverage run --rcfile=.coveragec --append  speclib/test_speclib_io_rastersources.py
python3 -m coverage run --rcfile=.coveragec --append  speclib/test_speclib_io_envi.py
python3 -m coverage run --rcfile=.coveragec --append  speclib/test_speclib_io_DEPR.py
python3 -m coverage run --rcfile=.coveragec --append  speclib/test_speclib_io_geopackage.py
