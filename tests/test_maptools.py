...
class TestMapTools(TestCase):
    ...
    def test_QgsMapTools(self):
        ...
        mt1.activate()
        me1 = QMouseEvent(QEvent.Type.MouseButtonPress, QPointF(0.5 * w, 0.5 * h), Qt.MouseButton.LeftButton,
        ...
        me1 = QMouseEvent(QEvent.Type.MouseButtonPress, QPointF(0, 0), Qt.MouseButton.LeftButton,
                          Qt.MouseButton.LeftButton, Qt.KeyboardModifier.NoModifier)
        me2 = QMouseEvent(QEvent.Type.MouseButtonPress, QPointF(0, w), Qt.MouseButton.LeftButton,
                          Qt.MouseButton.LeftButton, Qt.KeyboardModifier.NoModifier)
        me3 = QMouseEvent(QEvent.Type.MouseButtonPress, QPointF(h, w), Qt.MouseButton.LeftButton,
                          Qt.MouseButton.LeftButton, Qt.KeyboardModifier.NoModifier)
    ...
    def test_SpatialExtentMapTool(self):
        ...
        event = QMouseEvent(QEvent.Type.MouseMove, point, Qt.MouseButton.LeftButton, Qt.MouseButton.LeftButton,
                            Qt.KeyboardModifier.NoModifier)
        canvas.mouseMoveEvent(event)

        point = QPointF(0.6 * size.width(), 0.6 * size.height())
        event = QMouseEvent(
            QEvent.Type.MouseButtonRelease, point,
            Qt.MouseButton.LeftButton,
            Qt.MouseButton.LeftButton, Qt.KeyboardModifier.NoModifier
        )
