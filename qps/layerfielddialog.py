...
from PyQt5.QtWidgets import QComboBox, QGridLayout, QLabel, QDialogButtonBox, QHBoxLayout, QCheckBox
from qgis._core import QgsMapLayer, QgsField, QgsFieldProxyModel, QgsMapLayerProxyModel, QgsFieldModel, \
...
class SelectLayerFieldDialog(QDialog):
    ...
    def __init__(self, *args, **kwds):
        ...
        self.mCbShowAll = QCheckBox(r'Show all layers \& fields')
    ...
    def setLayerFilter(self, func: Callable):
        self.mLayerModel.setFilterFunc(func)

    def setFieldFilter(self, func: Callable):
